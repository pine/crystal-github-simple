  ...
  "files": [
    {
      ...
      commit.url.should eq("https://api.github.com/repos/octocat/Hello-World/commits/6dcb09b5b57875f334f61aebed695e2e4193db5e")
      commit.sha.should eq("6dcb09b5b57875f334f61aebed695e2e4193db5e")
    end
  end
end
